...
use alphaflow_derive::{ProtoBuf, ProtoBuf_Enum};
...
impl From<Authenticator> for AuthenticatorPB {
  fn from(auth_type: Authenticator) -> Self {
    match auth_type {
      ...
      Authenticator::AlphaflowCloud => AuthenticatorPB::AlphaflowCloud,
    }
  }
}
...
impl From<AuthenticatorPB> for Authenticator {
  fn from(pb: AuthenticatorPB) -> Self {
    match pb {
      ...
      AuthenticatorPB::AlphaflowCloud => Authenticator::AlphaflowCloud,
    }
  }
}
